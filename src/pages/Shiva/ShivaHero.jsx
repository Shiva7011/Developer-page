...
import PortfolioPage from "@/pages/About/ShivaAbout";
...
export default function ShivaHero() {
    const words = [
  "Back-End Developer",
  "React Developer & Java Specialist",
...
const profile = {
    name: 'Shiva Singh',
    title: 'Java Developer |Java Technology Enthusiast | Problem Solver',
    skills: [
        'React', 'Java', 'Rest API','SpringBoot', 'Postman',
        'MySQL', 'Docker', 'AWS',
         'Git', 'Website Development'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Java lover 🚀 | SpringBoot 🔧 | coding the future 💻✨
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://www.linkedin.com/in/shivasingh7011/"
                ...
                {/* Contact Button */}
                <a
                  href="https://github.com/Shiva7011"
