...
import PortfolioPage from "@/pages/About/GaganAbout";
...
export default function GaganHero() {
    const words = [
  "Front-End Developer & UI Engineer",
  "React Developer & JavaScript Specialist",
...
const profile = {
    ...
    skills: [
        ...
        'MySQL', 'MongoDB', 'AWS', 'React',
        'GraphQL', 'Git', 'Discord Development'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Html lover 🚀 | Node Js 🔧 | Crafting frameworks
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://www.linkedin.com/in/gagan-kumar-844903338"
                ...
                {/* Contact Button */}
                <a
                  href="https://github.com/gagankumar20"
